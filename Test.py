...
class GameShopGUI:
    ...
    # DO NOT TOUCH THIS FUNCTION - Unit 3 Sorting
    ...
    def on_filter_selection(self, event):
        ...
        if selected_option in option_mapping:
            ...
            self.display_games(sorted_games_data)  # This method needs to be implemented to update the UI with the sorted list
